...
python celebA_128.py --time_steps 4 --resolution_routine 'Incremental_factor_2'  --data_path '/data/code/data-celeba-tfr/celeba_128' --save_folder './celebA_4_steps_fac2_train'
